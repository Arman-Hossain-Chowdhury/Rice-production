...
f1<-autoplot(xts,series="Actual")+autolayer(fc1, series="Forecast")+autolayer(fitted(fc1), series="Fitted")+
  ylab("Rice production")+xlab("Year")+ggtitle("")+theme_bw()+theme_set(theme_bw()+theme(legend.position =c(0.1,0.9)))+
